...
public enum ModArmorMaterials implements ArmorMaterial {
    Pebble("pebble",20, new int[]{4, 6, 5, 4}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 2f, 5f, () ->Ingredient.of(ModItems.Pebble.get())),
    Yogurtium("yogurtium",30, new int[]{5, 7, 7, 5}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 3f, 5f, () ->Ingredient.of(ModItems.Yogurtium.get()));
    ...
    public String getName() {
        return BetterThanCoal.MOD_ID + ":" + this.name;
    }
